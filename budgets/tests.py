...
class TestCategoriesModel(TestCase):
    ...
    def test_user_cannot_create_two_budgets_that_overlap_slightly(self):
        Budget.objects.create(user=self.a_user, initial_date='2022-12-20', final_date='2023-12-20')

        with self.assertRaisesMessage(ValidationError, "['Budget is overlapping with another one.']"):
            Budget.objects.create(user=self.a_user, initial_date='2023-12-20', final_date='2027-05-26')

        with self.assertRaisesMessage(ValidationError, "['Budget is overlapping with another one.']"):
            Budget.objects.create(user=self.a_user, initial_date='2022-12-01', final_date='2022-12-20')
